    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a href="dokumentacija.pdf" target="_blank" class="text-white">Documentation</a>
        </div>
      </div>
    </div>
  </nav>
        ...
        <div class="col-12 col-md-6 col-lg-3 justify-content-center">
          ...
          <div class="mc-social d-flex">
            ...
            <div class="cs-icon cs-icon-gold mx-1">
             ...
             <div class="cs-icon cs-icon-gold mx-1">
              <a href="PCHarbour.zip" download target="_blank" class="text-white"><i class="fa-solid fa-download"></i></a>
            </div>
          </div>      
        </div>
      </div>
